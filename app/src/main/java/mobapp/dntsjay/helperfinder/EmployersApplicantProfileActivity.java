...
public class EmployersApplicantProfileActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employers_applicant_profile);
        ...
        if(bundle != null){
            ...
            final String job_applicantID = new_text.substring(0, new_text.length() - 1);
//            Toast.makeText(getApplicationContext(), job_applicantID, Toast.LENGTH_SHORT).show();
            mDatabase.child("employers_applicant").child(job_applicantID).addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ApplicantID = dataSnapshot.child("ApplicantID").getValue().toString();
                    DateApplied = dataSnapshot.child("DateApplied").getValue().toString();
                    JobID = dataSnapshot.child("JobID").getValue().toString();
                    JobOwnerID = dataSnapshot.child("JobOwnerID").getValue().toString();
    ...
    public void onClick(View v) {
        ...
        if(id == R.id.btnSendMessage){
            AlertDialog.Builder mBuilder = new AlertDialog.Builder(EmployersApplicantProfileActivity.this);
...
//                            @Override
//                            public void onSuccess(Void aVoid) {
//                                Toast.makeText(EmployersApplicantProfileActivity.this, "Successfully Sent a Message.",
...
//                                Toast.makeText(EmployersApplicantProfileActivity.this, "Failed to Send a Message.",
//                                        Toast.LENGTH_SHORT).show();
//                            }
//                        });
